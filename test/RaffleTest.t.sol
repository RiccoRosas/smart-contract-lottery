...
contract RaffleTest is Test {
    ...
    function testCheckUpkeepReturnsFalseIfItHasNoBalance() public {
        ...
        vm.roll(block.number + 1);
        //act
        (bool upkkeepNeeded, ) = raffle.checkUpkeep("");
        //assert
        assert(!upkkeepNeeded);
    }
    ...
    function testCheckUpkeepReturnsFalseIfEnoughTimeHasntPassed() public {
        ...
        (bool upkkeepNeeded, ) = raffle.checkUpkeep("");
        //assert
        assert(upkkeepNeeded == false); //not enough time has passed
    }
    ...
    // fulfillRandomWords//
    ///////////////////////
    function testFullfillRandomsWordsCanOnlyBeCalledAfterPreformUpkeep(
